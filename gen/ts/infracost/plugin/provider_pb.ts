 ...
 */
export type InvalidTag = Message<"infracost.plugin.InvalidTag"> & {
  /**
   * tag key (name)
   *
   * @generated from field: string key = 1;
...
export const InvalidTagSchema: GenMessage<InvalidTag> = /*@__PURE__*/
  messageDesc(file_infracost_plugin_provider, 27);
