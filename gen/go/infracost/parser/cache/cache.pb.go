...
type CloudFormationProject struct {
	...
	ConfigSha     string                 `protobuf:"bytes,9,opt,name=config_sha,json=configSha,proto3" json:"config_sha,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_infracost_parser_cache_cache_proto_rawDesc = "" +
	"\n" +
	"\"infracost/parser/cache/cache.proto\x12\x16infracost.parser.cache\x1a\x1fgoogle/protobuf/timestamp.proto\x1a,infracost/parser/cloudformation/result.proto\x1a!infracost/parser/diagnostic.proto\x1a'infracost/parser/terraform/module.proto\x1a\x1binfracost/usage/usage.proto\"\xb0\x03\n" +
	...
	"\x05usage\x18\t \x01(\v2\x16.infracost.usage.UsageR\x05usage\x12\x1d\n" +
	"\n" +
	"config_sha\x18\n" +
	" \x01(\tR\tconfigShaJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\b\x10\tR\n" +
	...
	"\x0eencrypted_data\x18\x03 \x01(\tR\rencryptedData\"\xe5\x02\n" +
	"\x15CloudFormationProject\x12?\n" +
	"\x06result\x18\x01 \x01(\v2'.infracost.parser.cloudformation.ResultR\x06result\x12<\n" +
	"\bmetadata\x18\x02 \x01(\v2 .infracost.parser.cache.MetadataR\bmetadata\x122\n" +
	"\x05diags\x18\x03 \x03(\v2\x1c.infracost.parser.DiagnosticR\x05diags\x12,\n" +
	"\x05usage\x18\b \x01(\v2\x16.infracost.usage.UsageR\x05usage\x12\x1d\n" +
	"\n" +
	"config_sha\x18\t \x01(\tR\tconfigShaJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\bR\n" +
