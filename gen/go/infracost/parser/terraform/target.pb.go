...
type Options struct {
	...
	TerraformCloudConfiguration *TerraformCloudConfiguration `protobuf:"bytes,11,opt,name=terraform_cloud_configuration,json=terraformCloudConfiguration,proto3" json:"terraform_cloud_configuration,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *Options) GetTerraformCloudConfiguration() *TerraformCloudConfiguration {
	if x != nil {
...
const file_infracost_parser_terraform_target_proto_rawDesc = "" +
	...
	"\aoptions\x18\x03 \x01(\v2#.infracost.parser.terraform.OptionsR\aoptions\"\x99\t\n" +
	"\aOptions\x12B\n" +
	...
	" \x01(\bR\x15forceLocalModulePaths\x12{\n" +
	"\x1dterraform_cloud_configuration\x18\v \x01(\v27.infracost.parser.terraform.TerraformCloudConfigurationR\x1bterraformCloudConfiguration\x1a<\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1b.infracost.parser.hcl.ValueR\x05value\"{\n" +
...
var file_infracost_parser_terraform_target_proto_goTypes = []any{
	...
	(*TerraformCloudConfiguration)(nil), // 4: infracost.parser.terraform.TerraformCloudConfiguration
...
var file_infracost_parser_terraform_target_proto_depIdxs = []int32{
	...
	4,  // 9: infracost.parser.terraform.Options.terraform_cloud_configuration:type_name -> infracost.parser.terraform.TerraformCloudConfiguration
